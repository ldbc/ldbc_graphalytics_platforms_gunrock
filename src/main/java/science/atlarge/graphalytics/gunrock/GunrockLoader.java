 ...
 * @author Owens Group
 */
public class GunrockLoader {

	private static final Logger LOG = LogManager.getLogger();

	protected CommandLine commandLine;
	protected FormattedGraph formattedGraph;
	protected GunrockConfiguration platformConfig;


	/**
	 *	Graph loader for Gunrock.
	 * @param formattedGraph
	 * @param platformConfig
	 */
	public GunrockLoader(FormattedGraph formattedGraph, GunrockConfiguration platformConfig) {
