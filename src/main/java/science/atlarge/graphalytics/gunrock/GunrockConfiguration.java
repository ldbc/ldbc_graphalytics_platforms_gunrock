 ...
 * @author Owens Group
 */
public final class GunrockConfiguration {

	protected static final Logger LOG = LogManager.getLogger();

	private static final String BENCHMARK_PROPERTIES_FILE = "benchmark.properties";
	private static final String HOME_PATH_KEY = "platform.gunrock.home";
	private static final String NUM_MACHINES_KEY = "platform.gunrock.num-machines";
	private static final String NUM_THREADS_KEY = "platform.gunrock.num-threads";
	...
	/**
	 * Creates a new GunrockConfiguration object to capture all platform parameters that are not specific to any algorithm.
	 */
	public GunrockConfiguration(){
	}
	...
	public static GunrockConfiguration parsePropertiesFile() {

		GunrockConfiguration platformConfig = new GunrockConfiguration();
