 ...
 * @author Owens Group
 */
public abstract class GunrockJob {
	...
	protected final GunrockConfiguration platformConfig;
	 ...
	 */
	public GunrockJob(RunSpecification runSpecification, GunrockConfiguration platformConfig,
