 ...
 */
package science.atlarge.graphalytics.gunrock.algorithms.pr;
...
/**
 * Page Rank job implementation for Gunrock. This class is responsible for formatting PR-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Owens Group
 */
public final class PageRankJob extends GunrockJob {
	 ...
	 */
	public PageRankJob(RunSpecification runSpecification, GunrockConfiguration platformConfig,
