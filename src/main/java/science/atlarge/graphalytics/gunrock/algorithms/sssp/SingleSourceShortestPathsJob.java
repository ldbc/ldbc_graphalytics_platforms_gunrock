 ...
 */
package science.atlarge.graphalytics.gunrock.algorithms.sssp;
...
/**
 * Single Source Shortest Paths job implementation for Gunrock. This class is responsible for formatting SSSP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Owens Group
 */
public final class SingleSourceShortestPathsJob extends GunrockJob {
	...
	public SingleSourceShortestPathsJob(RunSpecification runSpecification,
										GunrockConfiguration platformConfig,
