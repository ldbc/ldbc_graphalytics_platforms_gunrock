 ...
 */
package science.atlarge.graphalytics.gunrock.algorithms.cdlp;
...
/**
 * Community Detection job implementation for Gunrock. This class is responsible for formatting CDLP-specific
 * arguments to be passed to the platform executable, and does not include the implementation of the algorithm.
 *
 * @author Owens Group
 */
public final class CommunityDetectionLPJob extends GunrockJob {
	 ...
	 */
	public CommunityDetectionLPJob(RunSpecification runSpecification, GunrockConfiguration platformConfig,
